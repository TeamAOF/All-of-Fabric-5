# All-of-Fabric-5 1.1.1⟶all-of-fabric-5 1.1.2
...
Fix the issue where caracals when trying to find bed would crash the game
...
#### [8 more entries](https://www.curseforge.com/minecraft/mc-mods/pehkui/files/all)
